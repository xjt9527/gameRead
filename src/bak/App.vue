...
export default {
  ...
  data() {
    return {
      ...
      script: [
        { dlgs: 1 },
        { dlgs: 2, next: true, stay: 1 },
        { dlgs: 3, next: true, stay: 1.5 },
        { dlgs: 4, next: true, stay: 2 },
        { actors: 1, dlgs: 8, next: true, stay: 2 },
        { actors: 2, dlgs: 5, next: true, stay: 2.5 },
        { actors: 3, dlgs: 6, next: true, stay: 2.5 },
        { actors: 4, dlgs: 7, next: true, stay: 2.5 },
        { actors: 5, dlgs: 6, next: true, stay: 2.5 },
        { actors: 6, dlgs: 7 },
      ],
      actData: null,
      canAct: true,
